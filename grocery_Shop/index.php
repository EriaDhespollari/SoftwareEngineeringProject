        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> Grocery Shopping</a>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Find your shop, order and get free delivery</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <button onclick="location.href='shop.php'" type="button" class="btn theme-btn btn-lg">Get My Grocery</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Shop</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order Grocery</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Get Delivery</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
