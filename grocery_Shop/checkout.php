        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html" style="color:black">Grocery Shopping</a>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="#">Pick Your Grocery</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active" ><span>3</span><a href="#">Order and Get Delivery</a></li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo "L".$item_total; ?></strong></td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <ul class=" list-unstyled">
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    ...
                                                    <br> <span>Cash, Card and all type of digital payments are accepted</span> </label>
                                            </li>
