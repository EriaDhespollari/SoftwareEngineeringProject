                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Item to Store</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" class="form-control form-control-danger" placeholder="About Item">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" class="form-control" placeholder="L">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
